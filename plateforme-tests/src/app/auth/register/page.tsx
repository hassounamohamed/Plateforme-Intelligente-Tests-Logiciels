				...
				<div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					...
					<div className="hidden lg:flex flex-col justify-center gap-8 pl-10">
						<div className="relative">
							...
							<div className="rounded-2xl overflow-hidden shadow-2xl border border-primary-100/70 dark:border-primary-900/50 bg-white/95 dark:bg-surface-dark relative aspect-video group">
								...
								{/* Floating Badge */}
								<div className="absolute -bottom-6 -right-6 bg-white dark:bg-surface-dark p-4 rounded-xl shadow-xl border border-primary-100/70 dark:border-primary-900/50 flex items-center gap-3">
									<div className="flex -space-x-2">
										<div className="w-8 h-8 rounded-full bg-slate-300 border-2 border-white dark:border-surface-darkarkark overflow-hidden">
										...
										<div className="w-8 h-8 rounded-full bg-slate-300 border-2 border-white dark:border-surface-dark overflow-hidden">
										...
										<div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-[10px] font-bold border-2 border-white dark:border-surface-dark">
											+4k
										</div>
									</div>
