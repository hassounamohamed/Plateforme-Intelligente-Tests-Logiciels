  ...
  return (
    ...
    >
      <div className="max-w-350 mx-auto flex flex-col gap-6">
        <div className="bg-white dark:bg-surface-dark border border-slate-200 dark:border-[#3b4754] rounded-xl p-12 text-center">
          <span className="material-symbols-outlined text-slate-500 dark:text-[#9dabb9] text-[64px] mb-4">
            map
          </span>
